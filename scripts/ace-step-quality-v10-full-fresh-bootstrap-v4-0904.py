...
WORK = Path('/tmp/sonara-quality-v10-full-fresh-bootstrap-v4-0904')
...
def download(url: str, target: Path) -> None:
    ...
    req = urllib.request.Request(url, headers={'User-Agent': 'SONARA-QUALITY-V10-Bootstrap-V4/1.0'})
...
def run_bootstrap() -> None:
    banner('SONARA QUALITY V10 - CACHE-PROOF FULL BOOTSTRAP V4')
    print('BOOTSTRAP_VERSION=V4_0904', flush=True)
    ...
    if not runtime_base_ready():
        banner('1/8 - FRESH ACE-STEP + CUDA + XL-TURBO')
    ...
    banner('2/8 - REAL MUSIC V1 CONTRACT - SEMANTIC SAFE MODE')
    ...
    banner('3/8 - REAL MUSIC V2 SPEED/QUALITY')
    v2.require_runtime()
    ...
    banner('4/8 - VOCAL ASR V3 RESILIENT CUDA INSTALL')
    ...
    banner('6/8 - CUDA + ASR IMPORT PROBE')
    ...
    banner('7/8 - BOOTSTRAP V4 COMPLETE')
    print('BOOTSTRAP_V4=READY', flush=True)
...
def launch_speed_v9() -> None:
    banner('8/8 - QUALITY V10 / SPEED SUPERVISOR V9')
    ...
    exec(
        compile(code, '<SONARA-QUALITY-V10-V4-SPEED-V9>', 'exec'),
