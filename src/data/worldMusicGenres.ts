...
export const WORLD_MUSIC_GENRES: MusicGenreFamily[] = [
  {
    ...
    genres: [
      { name: 'House', subgenres: ['Classic House', 'Chicago House', 'Deep House', 'Tech House', 'Progressive House', 'Melodic House', 'Afro House', 'Tribal House', 'Soulful House', 'Funky House', 'French House', 'Filter House', 'Disco House', 'Jackin House', 'Acid House', 'Electro House', 'Future House', 'Bass House', 'Big Room House', 'Organic House', 'Latin House', 'Minimal House', 'Microhouse', 'Lo-Fi House', 'G-House', 'Garage House', 'Hard House', 'Piano House'] },
