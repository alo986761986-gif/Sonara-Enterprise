  ...
  return (
    <>
      <style>{`
        ...
        section[data-sonara-creator-mode="simple"]>[data-sonara-creator-block="taxonomy"],section[data-sonara-creator-mode="simple"]>[data-sonara-creator-block="musical"],section[data-sonara-creator-mode="simple"] [data-sonara-creative-controls="true"]{display:none!important}
        section[data-sonara-creator-skin="true"]>[data-sonara-creator-block="bpm"]{display:block!important;margin-top:14px!important;margin-bottom:16px!important;padding:14px 16px!important;border:1px solid rgba(168,85,247,.22)!important;border-radius:16px!important;background:linear-gradient(180deg,rgba(88,28,135,.10),#101013)!important}
        section[data-sonara-creator-skin="true"] input[aria-label="BPM preferiti"]{display:block!important;width:128px!important;min-width:128px!important;max-width:128px!important;padding-left:16px!important;padding-right:48px!important;text-align:left!important;color:#fff!important;-webkit-text-fill-color:#fff!important;caret-color:#fff!important;font-size:22px!important;font-weight:950!important;font-variant-numeric:tabular-nums!important;letter-spacing:.01em!important;opacity:1!important;appearance:textfield!important}
        section[data-sonara-creator-skin="true"] input[aria-label="BPM preferiti"]::-webkit-outer-spin-button,section[data-sonara-creator-skin="true"] input[aria-label="BPM preferiti"]::-webkit-inner-spin-button{-webkit-appearance:none!important;margin:0!important}
        ...
        section[data-sonara-creator-skin="true"] [data-sonara-creator-results="true"]{grid-column:2!important;grid-row:2/span 38!important;align-self:start!important;position:sticky!important;top:62px;z-index:2;margin:52px 18px 20px!important;display:grid!important;grid-template-columns:1fr!important;gap:12px!important;max-height:calc(100vh - 96px);overflow:auto;padding-right:2px}section[data-sonara-creator-skin="true"] [data-sonara-creator-results="true"] article{min-width:0;overflow:hidden;border-color:rgba(255,255,255,.07)!important;background:#131316!important;border-radius:18px!important}
        section[data-sonara-creator-skin="true"]>[data-sonara-creator-single-result="true"]{grid-column:2!important;grid-row:2/span 38!important;position:sticky;top:62px;min-width:0;overflow:hidden;margin:52px 18px 20px!important;border-color:rgba(255,255,255,.07)!important;background:#131316!important}
