        ...
        <div className="mx-auto flex max-w-[1800px] items-center justify-between gap-3 px-3 py-2.5 sm:px-5">
          <div className="flex min-w-0 items-center gap-3">
            ...
            <div className="min-w-0">
              <div className="flex items-center gap-2"><span className="truncate text-sm font-black text-white">SONARA DJ PRO</span><span className="rounded-full border border-emerald-500/20 bg-emerald-500/10 px-2 py-0.5 text-[7px] font-black tracking-wider text-emerald-300">AUTO HARDWARE</span></div>
              <div className="text-[8px] font-bold uppercase tracking-[0.2em] text-slate-600">Automatic Device Manager · Real MIDI/HID · Factory Profiles · Live Mirror</div>
            </div>
          </div>
