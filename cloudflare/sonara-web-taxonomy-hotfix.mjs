import sonaraEngine from './sonara-engine-v13-electronic-taxonomy-lock.mjs';
...
async function proxyWeb(request) {
  ...
  headers.set('x-sonara-edge-proxy', 'electronic-taxonomy-lock-v13');
  ...
  responseHeaders.set('x-sonara-edge-proxy', 'electronic-taxonomy-lock-v13');
