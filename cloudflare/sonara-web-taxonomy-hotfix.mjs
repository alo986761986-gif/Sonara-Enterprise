import sonaraEngine from './sonara-engine-v12-electronic-lock.mjs';
...
async function proxyWeb(request) {
  ...
  headers.set('x-sonara-edge-proxy', 'electronic-genre-lock-v12');
  ...
  responseHeaders.set('x-sonara-edge-proxy', 'electronic-genre-lock-v12');
